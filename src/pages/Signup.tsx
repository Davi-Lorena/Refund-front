...
async function onSubmit(e: React.FormEvent) {
  ...
  try {
    ...
    if(confirm("Cadastrado com sucesso! Ir para a tela de entrada?"))
      navigate("/")
...
<Input required legend="Confirme a senha" type="password" placeholder="123456" onChange={(e) => setPasswordConfirm(e.target.value)}/>
